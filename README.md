...
- Generates comprehensive statistics and reports to compare multiple DNS server results
...
3. Make sure the test scripts are executable: `chmod +x ./*.js`
...
# Run the DNS test against a multiple DNS servers and compare results
./dns_test.js 8.8.8.8 1.1.1.1
```
...
test_groups:
  international:
    ...
    - bbc.co.uk
  invalid:
    - example1111111nonexistentdomain.com
    - thisdomainisinvalidtooiguess.hu
...
- `dns_comparison.csv` - Comparison table of all DNS servers (generated by compare_results.js or by testing multiple DNS servers in one command)
